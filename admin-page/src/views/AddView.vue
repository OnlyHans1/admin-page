...
const selectedImageFile = ref('') // State to hold the selected image File
...
const insertDatabase = async () => {
  const imageURL = selectedImageURL.value.replace(/^blob:/, '');
  try {
...
const handleFileSelected = (file) => {
  ...
  selectedImageFile.value = file.name
    ...
    <section class="add__preview w-full">
      ...
      <div class="add__preview-card_container">
        ...
        <div class="add__preview-image_container">
          <img :src="selectedImageURL ? selectedImageURL : defaultImageURL" :alt=" selectedImageURL" />
        </div>
